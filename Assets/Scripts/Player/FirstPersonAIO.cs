...
public class FirstPersonAIO : MonoBehaviour
{
    ...
    public KeyCode cursorUnlockKey = KeyCode.LeftAlt;
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(cursorUnlockKey)) { ControllerPause(); }
        #endregion
...
public class FPAIO_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (t.lockAndHideCursor) 
        { 
            EditorGUI.indentLevel++; 
            EditorGUILayout.BeginHorizontal(); 
            t.cursorUnlockKey = (KeyCode)EditorGUILayout.EnumPopup(new GUIContent("Cursor Unlock Key", "Determines what key needs to be pressed to stop moving camera and enable cursor"), t.cursorUnlockKey); 
